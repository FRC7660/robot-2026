    ...
    public void execute() {
        ...
        for (SwerveModule module : modules) {
            ...
            if (pitCheckReading > PitCheckConstants.ANGLE_ENCODER_TOLERANCE) {
                ...
                String filePath = Filesystem.getDeployDirectory().toString() + File.separator + chassisDir + 
                    File.separator + "modules" + File.separator + posPath + ".json";
                try {
                ...
                SmartDashboard.putNumber(SDpath + "JSON encoder value",newNode.get("absoluteEncoderOffset").asDouble());
            }
        }
    }
